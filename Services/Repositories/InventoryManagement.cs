...
namespace ITHub.Services.Repositories
{
    public class InventoryManagement : IInventoryManagement
    {
        ...
        public Task<Response> CreateCategoryAsync(Category model)
        {
        ...
        Task<Response> IInventoryManagement.CreateShippingPricing(ShipmentPricingConfigDto model)
        {
            throw new NotImplementedException();
        }
        ...
        Task<Response> IInventoryManagement.DeleteShippingPricing(int Id)
        {
            throw new NotImplementedException();
        }
        ...
        Task<Response> IInventoryManagement.UpdateShippingPricing(int Id, ShipmentPricingConfigDto model)
        {
            throw new NotImplementedException();
        }
