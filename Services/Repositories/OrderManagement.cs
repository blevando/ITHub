...
namespace ITHub.Services.Repositories
{
    public class OrderManagement : IOrderManagement
    {
        ...
        //    public async Task<Response> CreateOrderAsync(string customerId, ProductDto model)
        //    {
        ...
        //    public async Task<Response> AddCommodityToOrderDetailAsync(string orderNumber, ProductDto model)
        //    {
        //        Response response = new Response();
        //        try
        //        {
        ...
        //    public async Task<Response> UpdateCommodityInOrderDetailAsync(string orderNumber, ProductDto model)
        //    {
